...
const query = (_query, _search) => _.promise(self => {
    ...
    self.query_search = _.coerce.string.nulled(_.d.first(_query, "/search/value"))
    if (_search && self.query_search) {
        self.query[_search] = [ "find", query_search ]
        self.query_search = null
    }
})
